...
if(isset($_GET["id"]) && $_GET["id"] > 0){
    $cliente->obtenerPorId(); //el cliente ya está cargado desde que se cargó el formulario
}
...
$(document).ready( function () {
    var idCliente = '<?php echo isset($cliente) && $cliente->idclientes > 0? $cliente->idclientes : 0 ?>';
